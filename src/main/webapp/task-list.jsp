            ...
            <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
              ...
              <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                <ul class="nav flex-column">
                  <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="<%= request.getContextPath() %>/task">
                      <svg class="bi">
                ...
                <ul class="nav flex-column mb-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2" href="<%= request.getContextPath() %>">
                      <svg class="bi">
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th class="w-[6rem]" scope="col">Completed</th>
